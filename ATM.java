...
public class ATM {
    public static void main(String[] args) {
        ...
        // Create a test user and display their ID and PIN
        User aUser = theBank.addUser("Aarsh", "Dhokai", "1111");

        // Print the User ID and PIN for testing
        System.out.println("Test User: User ID = " + aUser.getUUID() + ", PIN = 1111");
    ...
    public static void transferFunds(User theUser, Scanner sc) {
        ...
        do {
            System.out.println("Enter the amount to transfer (max $ " + actBal + "): $");
            amount = sc.nextDouble();
            if (amount < 0) {
                System.out.println("Amount must be greater than zero.");
            } else if (amount > actBal) {
                System.out.println("Amount must not be greater than balance of $" + actBal);
            }
        ...
        theUser.addActTransaction(toAct, amount, String.format("Transfer from account " + theUser.getActUUID(fromAct)));
    }
    ...
    public static void depositFunds(User theUser, Scanner sc) {
        ...
        do {
            System.out.print("Enter the amount to deposit (max $ " + actBal + "): $");
            amount = sc.nextDouble();
            if (amount < 0) {
                System.out.println("Amount must be greater than zero.");
            }
